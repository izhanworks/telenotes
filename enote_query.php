...
include('user_auth.php');   
        ...
        $notes = trim($notes);
            ...
            if (!empty($dflag)) {
        		$query=mysqli_query($con, "update tblnotes set title='$title',notes='$notes' where randomid='$dflag'");
//query data			
...
//end query data     
    ...
    $ret=mysqli_query($con,"select * from tblnotes where randomid ='$dflag'");
        ...
        $rrid = $dataresult['id'];
			...
			$retx=mysqli_query($con,"select * from tblnotes where randomid ='$dflag'");
